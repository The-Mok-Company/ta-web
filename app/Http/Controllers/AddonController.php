...
class AddonController extends Controller
{
    ...
    public function check_activation( $data){
        // Skip activation check - allow addon installation without activation
        return true;
    }

    public static function checkVerification( $type, $key){
        // Skip activation check - allow addon/domain use without verification
        return true;
    }

    public static function checkActivation( $type, $key){
        // Skip activation check - allow addon/domain use without activation
        return true;
    }
