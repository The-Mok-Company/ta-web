            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="brand">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id" required>
                    ...
                    <div class="form-group row" id="product_group">
                        <label class="col-lg-3 col-from-label">{{translate('Product Group')}} <span class="text-danger">*</span></label>
                        <div class="col-lg-8">
                            ...
                            <small class="form-text text-muted">{{ translate('Product groups are filtered by selected sub-category') }}</small>
                        </div>
                    </div>
                    <div class="form-group row">
