...
======================== */
    ...
    /* Sub Categories at Bottom - Above Image */
                        ...
                        <div class="col-lg-6 col-md-6">
                            <a href="{{ route('categories.level2', $category->id) }}" class="text-decoration-none">
                                <div class="category-card">
                                    <img src="{{ uploaded_asset($category->banner) }}" alt="{{ $category->getTranslation('name') }}" onerror="this.src='{{ static_asset('assets/img/placeholder.jpg') }}'">
