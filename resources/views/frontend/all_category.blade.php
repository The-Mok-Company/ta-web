...
.add-inquiry-btn.added .icon-check::before{ content:"✓"; }
    ...
    .categories-hero > * { position: relative; z-index: 2; }
    ...
    /* Hover – make it clearly a button */
            ...
            @foreach ($categories as $category)
                <div class="category-card-wrap">
                    ...
                    <a href="{{ route('products.category', $category->slug) }}" class="category-card">
                        <img
                            src="{{ $category->banner ? uploaded_asset($category->banner) : asset('assets/img/eaf877854196422d963fe04e58d086e83a98ac67.png') }}"
