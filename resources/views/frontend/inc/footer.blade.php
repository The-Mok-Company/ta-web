    ...
    <div class="footer-container">
        <div class="footer-top">
            <div class="footer-left">
                ...
                @if(get_setting('about_us_description', null, $system_language->code))
                    <p class="tagline">{!! strip_tags(get_setting('about_us_description', null, $system_language->code)) !!}</p>
                @else
            ...
            <div class="footer-right">
                ...
                <div class="social-section">
                    ...
                    <div class="social-icons">
                        ...
                        <a href="{{ get_setting('facebook_link') }}" target="_blank" rel="noopener noreferrer" class="social-icon facebook">
                        ...
                        <a href="{{ get_setting('twitter_link') }}" target="_blank" rel="noopener noreferrer" class="social-icon twitter">
                        ...
                        <a href="{{ get_setting('instagram_link') }}" target="_blank" rel="noopener noreferrer" class="social-icon instagram">
                        ...
                        <a href="{{ get_setting('youtube_link') }}" target="_blank" rel="noopener noreferrer" class="social-icon youtube">
                        ...
                        <a href="{{ get_setting('linkedin_link') }}" target="_blank" rel="noopener noreferrer" class="social-icon linkedin">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="18"
                                height="18" fill="currentColor">
                                <path
            ...
            <div class="footer-links">
                ...
                <div class="footer-column">
                    ...
                    <div class="contact-info">
                        @if(get_setting('contact_address', null, $system_language->code))
                        <p class="contact-label">Address</p>
                        <p class="contact-value">{{ get_setting('contact_address', null, $system_language->code) }}</p>
                        @endif
                        @if(get_setting('contact_phone'))
                        <p class="contact-label">Phone</p>
                        <p class="contact-value">{{ get_setting('contact_phone') }}</p>
                        @endif
                        @if(get_setting('contact_email'))
                        <p class="contact-label">Email</p>
                        <p class="contact-value">{{ get_setting('contact_email') }}</p>
                        @endif
                    </div>
                </div>
        ...
        @if(get_setting('frontend_copyright_text', null, $system_language->code))
        <div class="footer-copyright" style="border-top: 1px solid #404052; padding-top: 30px; margin-top: 40px; text-align: center;">
            <div style="color: #b8b8c7; font-size: 14px;">
                {!! get_setting('frontend_copyright_text', null, $system_language->code) !!}
            </div>
        </div>
        @endif
    </div>
