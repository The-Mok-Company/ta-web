		...
		<div class="col-lg-8 col-xxl-6 mx-auto">
			<div class="card">
				...
				<div class="card-body">
					...
					<form action="{{ route('new_update') }}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<div class="row gutters-5 mt-3">
							<div class="col-md">
		                        <div class="form-group">
		                            <label for="purchase_code" class="fs-12 fw-700" style="color: #666;">Purchase Code (optional)</label>
		                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="purchase_code" name="purchase_code" placeholder="Leave blank to skip">
		                        </div>
						...
						<div class="row gutters-5">
							<div class="col-md">
		                        <div class="form-group">
		                            <label for="system_key" class="fs-12 fw-700" style="color: #666;">System Key (optional)</label>
		                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="system_key" name="system_key" placeholder="Leave blank to skip">
		                        </div>
	                        </div>
	                    </div>
						<div class="row gutters-5">
