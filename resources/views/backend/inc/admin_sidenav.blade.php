    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                'add_digital_product', 'edit_digital_product', 'product_bulk_import', 'product_bulk_export',
                'view_product_categories', 'view_all_brands', 'brand_bulk_upload', 'view_product_attributes',
                'view_colors', 'view_product_warranties', 'smart-bar', 'view_custom_label', 'view_product_reviews'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('digitalproducts.create') }}" class="aiz-side-nav-link {{ areActiveRoutes(['digitalproducts.create']) }}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('attributes.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['attributes.index', 'attributes.create', 'attributes.edit', 'attributes.show']) }}">
                        ...
                        @can('view_colors')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('colors') }}" class="aiz-side-nav-link {{ areActiveRoutes(['colors', 'colors.edit', 'colors.create']) }}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                                        ...
                                        '<', \Carbon\Carbon::now()->subDay(),
                                            ...
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('all_preorder.list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder-order.show']) }} }}">
                                                    <span class="aiz-side-nav-text">{{ translate('All Orders') }} <span class="badge badge-info ml-1">{{ $all_preorders_count ?: '' }}</span>
                                                    </span>
                                                </a>
                                            </li>
                                            @endcan
                                            ...
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('delayed_prepayment_preorders.list') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{ translate('Delayed Prepayment') }}
                                                        <span class="badge badge-info ml-1">{{ $delayed_prepayment_preorders_count ?: '' }}</span></span>
                                                </a>
                                            </li>
                                            @endcan
                                            ...
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('delayed_final_orders.list') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{ translate('Delayed Final Orders') }}
                                                        <span class="badge badge-info ml-1">{{ $delayed_final_orders_count ?: '' }}</span></span>
                                                </a>
                                            </li>
                                            @endcan
                            </ul>
                        ...
                        @endphp
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('preorder-conversations.admin_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder-conversations.admin_index', 'preorder-conversations.admin_show']) }}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('preorder.product_query.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder.product_query.index', 'preorder.product_query.show']) }}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('preorder.product_reviews.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder.product_detail_reviews']) }}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('preorder-notification-types.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder.notification-type.edit']) }}">
   ...
   <
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Inquery') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{ route('admin.inquiries.create') }}">
                                <span class="aiz-side-nav-text">{{ translate('Add New Inquery') }}</span>
                            </a>
                        </li>
                      
                       
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{ route('admin.inquiries.index') }}">
                                <span class="aiz-side-nav-text">{{ translate('Inquery List') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        {{-- Join Us --}}
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{ route('settings.join_us') }}">
                                <span class="aiz-side-nav-text">{{ translate('Join Us') }}</span>
                            </a>
                        </li>
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16.001"
                                    ...
                                    <path
                                        d="M.333,16A.315.315,0,0,1,0,15.668V.335A.315.315,0,0,1,.333,0h9.31a.285.285,0,0,1,.123.014A.318.318,0,0,1,9.9.1l2.667,2.667.009.01a.293.293,0,0,1,.079.132.274.274,0,0,1,.012.112V5.835l1.267-1.267a.322.322,0,0,1,.466,0l1.5,1.5a.322.322,0,0,1,0,.466L12.667,9.768v5.9a.315.315,0,0,1-.333.333Z"
                                        fill="#575b6a" />
                                </svg>
                            </div>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('custom-alerts.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['custom-alerts.index', 'custom-alerts.create', 'custom-alerts.edit', 'custom-sale-alert.edit']) }}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('custom-sale-alerts.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['custom-sale-alerts.index']) }}">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('custom_product_visitors') }}" class="aiz-side-nav-link {{ areActiveRoutes(['custom_product_visitors']) }}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('shipping_system') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping_system']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Shippping Configuration') }}</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
                ...
                'authentication_layout_settings', 'top_banner_setting', 'view_top_banner'])
                <li class="aiz-side-nav-item">
                ...
                'manage_shipping_states', 'manage_shipping_cities', 'manage_zones', 'manage_carriers',
                'shipping_box_size_index', 'pickup_address_index'])
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                    ...
                    <ul class="aiz-side-nav-list level-3">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('shipping_box_size.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['shipping_box_size.index', 'shipping_box_size.create', 'shipping_box_size.edit']) }}">
