                            ...
                            @can('show_all_products')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('products.all') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['digitalproducts.edit']) }}">
                                ...
                                @can('show_seller_products')
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <ul class="aiz-side-nav-list level-3">
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('products.seller', 'all') }}"
                                                    class="aiz-side-nav-link {{ areActiveRoutes(['products.seller.edit']) }}">
                                                    <span class="aiz-side-nav-text">{{ translate('All Products') }}</span>
                                                </a>
                                            </li>
                                            <li class="aiz-side-nav-item">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @can('manage_shipping_system')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('shipping_system') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['shipping_system']) }}">
                                            <span
                                                class="aiz-side-nav-text">{{ translate('Shippping Configuration') }}</span>
                                        </a>
                                    </li>
                                @endcan
                            </ul>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('gst_assign')
                                ...
                                @if (addon_is_activated('wholesale'))
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('products.wholesale-hsn-gst.assigns') }}"
                                            class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Wholesale Products') }}</span>
                                        </a>
                                    </li>
                                ...
                                @if (addon_is_activated('preorder'))
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('products.preorder-hsn-gst.assigns') }}"
                                            class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Preorder Products') }}</span>
                                        </a>
                                    </li>
                                ...
                                @if (addon_is_activated('auction'))
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('products.auction-hsn-gst.assigns') }}"
                                            class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Auction Products') }}</span>
                                        </a>
                                    </li>
                            ...
                            @canany(['view_top_banner'])
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        @can('view_top_banner')
                                            <li class="aiz-side-nav-item">
                                                <a class="aiz-side-nav-link {{ areActiveRoutes(['top_banner.create', 'top_banner.edit']) }}"
                                            ...
                                            @can('pickup_address_index')
                                                <li class="aiz-side-nav-item">
                                                    <a href="{{ route('pickup_address.index') }}"
                                                        ...
                                                        <span
                                                            class="aiz-side-nav-text">{{ translate('Pickup Addresses') }}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('shipping_box_size_index')
                                                <li class="aiz-side-nav-item">
                                                    <a href="{{ route('shipping_box_size.index') }}"
                                                        ...
                                                        <span
                                                            class="aiz-side-nav-text">{{ translate('Shipping Box Size Configuration') }}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                        @endif
